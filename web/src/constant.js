...
const CONSTANT = {
    ...
    WAYS_DATA: [
        ...
        },
        {
            ...
            label: '企业微信应用',
            inputs: [
                { subLabel: '企业ID', value: '', col: 'corpid', desc: "企业微信管理后台的企业ID" },
                { subLabel: '应用Secret', value: '', col: 'corpsecret', desc: "自建应用的corpsecret" },
                { subLabel: '应用AgentID', value: '', col: 'agentid', desc: "自建应用的AgentID" },
                { subLabel: '渠道名', value: '', col: 'name', desc: "想要设置的渠道名字" },
            ],
            tips: {
                text: "企业微信应用说明",
                desc: "使用企业微信自建应用发送消息。<br />1. 登录企业微信管理后台 -> 应用管理 -> 自建应用<br />2. 获取 CorpID、CorpSecret 和 AgentID<br />3. 需要在应用可见范围内配置接收人<br />4. 调用服务器IP需加入企业微信白名单"
            },
            taskInsRadios: [
                { subLabel: 'text', content: 'text' },
                { subLabel: 'markdown', content: 'markdown' },
                ...
                modes: [
                    {
                        ...
                        label: '发送给个人',
                        inputs: [
                            { value: '', col: 'touser', desc: "接收人userid，用竖线分隔多个用户", label: '接收人' },
                        ]
                    },
                    {
                        value: 'group',
                        label: '发送到群聊',
                        useChatSelector: true,
                    }
                ]
            },
            taskInsInputs: [
